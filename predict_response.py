...
def preprocess_user_input(user_input):
    ...
    texto = "Eu gosto de aprender processamento de linguagem natural."
    ...
    textos = ["Eu gosto de aprender processamento de linguagem natural."]
    tokenized_texts = [[stemmer.stem(word) for word in word_tokenize(texto, language='portuguese')] for texto in textos]
